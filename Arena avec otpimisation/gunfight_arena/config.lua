-- ================================================================================================
-- GUNFIGHT ARENA - CONFIGURATION v4.0 OPTIMISÉE CPU
-- ================================================================================================
...
Config.LobbyPed = {
    ...
    pos = vector3(221.657150, -868.087890, 30.476196),
    heading = 153.070878,
    frozen = true,
    invincible = true,
    blockevents = true,
...
-- ================================================================================================
-- 🆕 ZONE 10 - BASE MILITAIRE (MINI)
-- ================================================================================================
Config.Zone10 = {
    enabled = true,
    image = "images/zone10.png",
    radius = 90.0,
...
-- ================================================================================================
-- IMPORTANT: Ces valeurs ont été optimisées pour réduire la charge CPU
-- Ne pas descendre sous ces valeurs sans raison valable
Config.Threads = {
    -- Vérification de mort: 500ms suffit (pas besoin de temps réel)
    deathCheck = 500,
    
    -- Reset stamina: 1000ms est suffisant
    staminaReset = 1000,
    
    -- Marqueur de zone: 0 car c'est du rendu (obligatoire)
    zoneMarker = 0,
    
    -- Interaction PED: 250ms (on n'a pas besoin de plus)
    pedInteraction = 250,
    
    -- Vérification zone: 1000ms suffit
    zoneCheck = 1000,
    
    -- Auto-join (désactivé): 2000ms
    autoJoin = 2000,
    
    -- Message d'aide: 0 car c'est du rendu (obligatoire)
    helpMessage = 0,
    
    -- 🆕 Distance check pour activation: 500ms
    distanceCheck = 500,
